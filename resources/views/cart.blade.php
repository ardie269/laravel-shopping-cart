        	...
        	<div class="row">
                ...
                <div class="col-lg-5">
                	<p>
                		...
                		<b>Sub Total: </b>{{ number_format(\Cart::get($item->id)->getPriceSum(), 2) }}<br>
    		...
    		<div class="col-lg-5">
				 <div class="card">
				 	<ul class="list-group list-group-flush">
				 		<li class="list-group-item"><b>Total: </b> {{ number_format (\Cart::getTotal() , 2) }}</li>
				 	</ul>
				 </div>

	    		<br>
	    		<a href="/" class="btn btn-dark r-3">Continue Shopping</a> 
